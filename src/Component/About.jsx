    ...
    return (
        <div>
            ...
            <div id="cd1">
                ...
                <ul id="p" style={{ listStyleType: 'square', color: '#005585', 'opacity': 0.85, 'fontWeight': 'bold' }}><li>
                    Getting Started with SAP Cloud Application Programming Model - Record of Achievement | SAP | Cloud Application Programming
                </li>
                    <li>
